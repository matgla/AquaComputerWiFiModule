...
message("ARDUINO PATH: ${CMAKE_CURRENT_LIST_DIR}/Modules")
...
set(LINKER_SCRIPTS_PATH "${ARDUINO_ESP8266_ROOT}/tools/sdk/ld" CACHE STRING "Path to linker scripts directory" FORCE)
...
set(LINKING_GROUP "-lmesh -lwpa2 -lsmartconfig -lespnow -lpp -lmain -lwpa -llwip_gcc -lnet80211 -lwps -lcrypto -lphy -lhal -laxtls -lgcc -lm -lc -lstdc++")

set(CMAKE_C_LINK_EXECUTABLE "<CMAKE_CXX_COMPILER> -o <TARGET> <LINK_FLAGS> <OBJECTS> -Wl,--start-group <LINK_LIBRARIES> ${LINKING_GROUP} -Wl,--end-group")
set(CMAKE_CXX_LINK_EXECUTABLE "<CMAKE_CXX_COMPILER> -o <TARGET> <LINK_FLAGS> <OBJECTS> -Wl,--start-group <LINK_LIBRARIES> ${LINKING_GROUP} -Wl,--end-group")

# SET(CMAKE_CXX_ARCHIVE_CREATE "<CMAKE_AR> cru <TARGET> <OBJECTS>")
# SET(CMAKE_C_ARCHIVE_CREATE "<CMAKE_AR> cru <TARGET> <OBJECTS>")
# SET(CMAKE_ASM_ARCHIVE_CREATE "<CMAKE_AR> cru <TARGET> <OBJECTS>")
