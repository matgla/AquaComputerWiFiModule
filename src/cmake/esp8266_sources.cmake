...
set(esp8266_srcs
    ...
    # ${ESP_SRC_DIR}/net/http/httpConnection_esp.cpp
    # ${ESP_SRC_DIR}/net/socket/tcpClient_esp.cpp
    # ${ESP_SRC_DIR}/net/socket/tcpServer_esp.cpp
    # ${ESP_SRC_DIR}/net/socket/tcpSession.cpp
...
set(esp8266_incs
    # ${ESP_SRC_DIR}/net/http/httpConnection_esp.hpp
    # ${ESP_SRC_DIR}/net/socket/tcpSession.hpp
)
